...
func HumanMessage(topic string) string {
	...
	USER'S INPUT
	----------------------------
	Here is the user's input (remember to respond with a json array, and NOTHING else):
	Generate 5 motivational phrases to make me leave my smartphone based on topic of %s. 
